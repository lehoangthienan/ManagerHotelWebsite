<div class="row">
	<div class="col-lg-12 col-md-12 col-xs-12 col-sm-12" id="slider">
		<div id="wowslider-container">
			...
			?>
			<div id="Searchbox">
				<form name="frmthongtin" method="POST">
					<input class="aaa" type="text" name="txtTuKhoa">
					<?php //selectCtrl('parent','forFormdim'); ?>
					<input class="bbb" type="date" name="ngayden" value="<?php echo date("Y-m-d"); ?>">
					<input class="bbb" type="date" name="ngaydi" value="<?php echo date("Y-m-d"); ?>">

	 				<td colspan="2"><input class="ccc" href="" type="submit" name="submit" value="TÌM KIẾM" /></td>	
